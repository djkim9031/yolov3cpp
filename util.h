...
namespace {
    ...
    void draw_text(cv::Mat& img, const std::string& str,
        ...
        auto t_size = cv::getTextSize(str, cv::FONT_HERSHEY_COMPLEX, 1, 2, nullptr);
        ...
        cv::putText(img, str, bottom_left, cv::FONT_HERSHEY_COMPLEX, 1, cv::Scalar(255, 255, 255) - color, 2);
    }
    ...
    auto read_txt(const std::string filename) {
